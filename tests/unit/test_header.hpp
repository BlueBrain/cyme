...
typedef boost::mpl::list<data<float, 14, cyme::AoS>, data<double, 14, cyme::AoS>> generic_test_types;

typedef boost::mpl::list<data<float, 14, cyme::AoS>, data<float, 14, cyme::AoSoA>, data<double, 14, cyme::AoS>,
                         data<double, 14, cyme::AoSoA>>
    floating_point_test_types;
// max 20 elements, because MPL must emulate variadic template
typedef boost::mpl::list<
    data_block<double, 3, 3, cyme::AoS>, data_block<float, 4, 3, cyme::AoSoA>, data_block<double, 5, 3, cyme::AoSoA>,

    data_block<double, 3, 4, cyme::AoS>, data_block<float, 4, 4, cyme::AoSoA>, data_block<double, 5, 4, cyme::AoSoA>,

    data_block<double, 3, 5, cyme::AoS>, data_block<float, 4, 5, cyme::AoSoA>, data_block<double, 5, 5, cyme::AoSoA>,

    data_block<double, 3, 6, cyme::AoS>, data_block<float, 4, 6, cyme::AoSoA>, data_block<double, 5, 6, cyme::AoSoA>

    >
    floating_point_torture_list;

typedef boost::mpl::list<data_block<float, 6, 15, cyme::AoS>, data_block<float, 7, 13, cyme::AoSoA>,
                         data_block<float, 8, 11, cyme::AoS>, data_block<double, 6, 15, cyme::AoS>,
                         data_block<double, 7, 13, cyme::AoSoA>, data_block<double, 8, 11, cyme::AoS>>

...
/*
    ...
    for(int i=0; i <SIZE; i++)
      block_aos(i,0) = (block_aos(i,1)*(block_aos(i,2)*(block_aos(i,3)+block_aos(i,4)) + block_aos(i,5)*(block_aos(i,6)+block_aos(i,7))) +8.1 )/block_aos(i,7);
    t2 = rdtsc();

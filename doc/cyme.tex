...
Containers with two data layout
 \begin{lstlisting}[flexiblecolumns=true,basicstyle=\sffamily]     
      vector<object,double,AoS> block_AoS;       
      vector<object,double,AoSoA>    block_AoSoA;
\end{lstlisting}
...
AoS ideology, easier to represent in mind
...
Generic syntax: 
 \begin{lstlisting}[flexiblecolumns=true,basicstyle=\sffamily]     
      cyme:vector<object,double,AoSoA/AoS> block;
      typename block<object,double,AoSoA/AoS>::iterator it;

...
_mm_round_up_even<cyme::sse, 2>(simd_trait<int, cyme::sse, 2>::register_type xmm0) {
    ...
    return simd_trait<int, cyme::sse, 2>::register_type(xmm0.r0, xmm0.r1);
}
...
_mm_round_up_even<cyme::sse, 4>(simd_trait<int, cyme::sse, 4>::register_type xmm0) {
    ...
    return simd_trait<int, cyme::sse, 4>::register_type(xmm0.r0, xmm0.r1, xmm0.r2, xmm0.r3);
}
...
_mm_single_load<double, cyme::sse, 1>(const simd_trait<double, cyme::sse, 1>::value_type b) {
...
_mm_load1<double, cyme::sse, 4>(const simd_trait<double, cyme::sse, 4>::value_type &a) {
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_set1_pd(a), _mm_set1_pd(a), _mm_set1_pd(a),
                                                           _mm_set1_pd(a));
}
...
_mm_load<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::const_pointer a) {
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_load_pd(a), _mm_load_pd(a + 2), _mm_load_pd(a + 4),
                                                           _mm_load_pd(a + 6));
}
...
_mm_gather<double, cyme::sse, 2>(const double *src, const int *ind, const int __attribute__((unused)) range) {
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_setr_pd(src[ind[0]], src[ind[1]]),
...
_mm_gather<double, cyme::sse, 4>(const double *src, const int *ind, const int __attribute__((unused)) range) {
    return simd_trait<double, cyme::sse, 4>::register_type(
        _mm_setr_pd(src[ind[0]], src[ind[1]]), _mm_setr_pd(src[ind[2]], src[ind[3]]),
        _mm_setr_pd(src[ind[4]], src[ind[5]]), _mm_setr_pd(src[ind[6]], src[ind[7]]));
}
...
_mm_mul<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0,
    ...
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_mul_pd(xmm0.r0, xmm1.r0), _mm_mul_pd(xmm0.r1, xmm1.r1));
}
...
_mm_mul<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
    ...
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_mul_pd(xmm0.r0, xmm1.r0), _mm_mul_pd(xmm0.r1, xmm1.r1),
                                                           _mm_mul_pd(xmm0.r2, xmm1.r2), _mm_mul_pd(xmm0.r3, xmm1.r3));
}
...
_mm_div<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0,
                              simd_trait<double, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_div_pd(xmm0.r0, xmm1.r0), _mm_div_pd(xmm0.r1, xmm1.r1));
}
...
_mm_div<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
                              simd_trait<double, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_div_pd(xmm0.r0, xmm1.r0), _mm_div_pd(xmm0.r1, xmm1.r1),
                                                           _mm_div_pd(xmm0.r2, xmm1.r2), _mm_div_pd(xmm0.r3, xmm1.r3));
}
...
_mm_add<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0,
                              simd_trait<double, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_add_pd(xmm0.r0, xmm1.r0), _mm_add_pd(xmm0.r1, xmm1.r1));
}
...
_mm_add<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
                              simd_trait<double, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_add_pd(xmm0.r0, xmm1.r0), _mm_add_pd(xmm0.r1, xmm1.r1),
                                                           _mm_add_pd(xmm0.r2, xmm1.r2), _mm_add_pd(xmm0.r3, xmm1.r3));
}
...
_mm_sub<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0,
                              simd_trait<double, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_sub_pd(xmm0.r0, xmm1.r0), _mm_sub_pd(xmm0.r1, xmm1.r1));
}
...
_mm_sub<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
                              simd_trait<double, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_sub_pd(xmm0.r0, xmm1.r0), _mm_sub_pd(xmm0.r1, xmm1.r1),
                                                           _mm_sub_pd(xmm0.r2, xmm1.r2), _mm_sub_pd(xmm0.r3, xmm1.r3));
}
...
_mm_rec<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0) {
    return simd_trait<double, cyme::sse, 4>::register_type(
        _mm_cvtps_pd(_mm_rcp_ps(_mm_cvtpd_ps(xmm0.r0))), _mm_cvtps_pd(_mm_rcp_ps(_mm_cvtpd_ps(xmm0.r1))),
        _mm_cvtps_pd(_mm_rcp_ps(_mm_cvtpd_ps(xmm0.r2))), _mm_cvtps_pd(_mm_rcp_ps(_mm_cvtpd_ps(xmm0.r3))));
}
...
_mm_neg<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0) {
    simd_trait<double, cyme::sse, 1>::register_type mask(_mm_castsi128_pd(_mm_set1_epi64x(0x8000000000000000)));
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_xor_pd(xmm0.r0, mask), _mm_xor_pd(xmm0.r1, mask));
}
...
_mm_neg<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0) {
    simd_trait<double, cyme::sse, 1>::register_type mask(_mm_castsi128_pd(_mm_set1_epi64x(0x8000000000000000)));
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_xor_pd(xmm0.r0, mask), _mm_xor_pd(xmm0.r1, mask),
                                                           _mm_xor_pd(xmm0.r2, mask), _mm_xor_pd(xmm0.r3, mask));
}
...
_mm_floor<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0) {
    return simd_trait<int, cyme::sse, 4>::register_type(
        _mm_cvttpd_epi32(_mm_floor_pd(xmm0.r0)), _mm_cvttpd_epi32(_mm_floor_pd(xmm0.r1)),
...
_mm_ge<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0) {
    ...
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_cvtepi32_pd(tmp0), _mm_cvtepi32_pd(tmp1));
}
...
_mm_ge<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0) {
    ...
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_cvtepi32_pd(tmp0), _mm_cvtepi32_pd(tmp1),
                                                           _mm_cvtepi32_pd(tmp2), _mm_cvtepi32_pd(tmp3));
}
...
_mm_gf<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0) {
    ...
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_castsi128_pd(tmp0), _mm_castsi128_pd(tmp1));
}
...
_mm_gf<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0) {
    ...
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_castsi128_pd(tmp0), _mm_castsi128_pd(tmp1),
                                                           _mm_castsi128_pd(tmp2), _mm_castsi128_pd(tmp3));
}
...
_mm_sqrt<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0) {
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_sqrt_pd(xmm0.r0), _mm_sqrt_pd(xmm0.r1));
}
...
_mm_sqrt<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0) {
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_sqrt_pd(xmm0.r0), _mm_sqrt_pd(xmm0.r1),
                                                           _mm_sqrt_pd(xmm0.r2), _mm_sqrt_pd(xmm0.r3));
}
...
_mm_rsqrt<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0) {
    return simd_trait<double, cyme::sse, 4>::register_type(
        _mm_cvtps_pd(_mm_rsqrt_ps(_mm_cvtpd_ps(xmm0.r0))), _mm_cvtps_pd(_mm_rsqrt_ps(_mm_cvtpd_ps(xmm0.r1))),
        _mm_cvtps_pd(_mm_rsqrt_ps(_mm_cvtpd_ps(xmm0.r2))), _mm_cvtps_pd(_mm_rsqrt_ps(_mm_cvtpd_ps(xmm0.r3))));
}
...
_mm_fabs<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0) {
    simd_trait<double, cyme::sse, 1>::register_type mask = _mm_castsi128_pd(_mm_set1_epi64x(0x7fffffffffffffff));
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_and_pd(xmm0.r0, mask), _mm_and_pd(xmm0.r1, mask));
}
...
_mm_fabs<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0) {
    simd_trait<double, cyme::sse, 1>::register_type mask = _mm_castsi128_pd(_mm_set1_epi64x(0x7fffffffffffffff));
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_and_pd(xmm0.r0, mask), _mm_and_pd(xmm0.r1, mask),
                                                           _mm_and_pd(xmm0.r2, mask), _mm_and_pd(xmm0.r3, mask));
}
...
_mm_select_sign_sin<double, cyme::sse, 2>(simd_trait<int, cyme::sse, 2>::register_type swap,
    ...
    return simd_trait<double, cyme::sse, 2>::register_type(xmm1.r0, xmm1.r1);
}
...
_mm_select_sign_sin<double, cyme::sse, 4>(simd_trait<int, cyme::sse, 4>::register_type swap,
    ...
    return simd_trait<double, cyme::sse, 4>::register_type(xmm1.r0, xmm1.r1, xmm1.r2, xmm1.r3);
}
...
_mm_select_sign_cos<double, cyme::sse, 4>(simd_trait<int, cyme::sse, 4>::register_type swap,
    ...
    return simd_trait<double, cyme::sse, 4>::register_type(xmm0.r0, xmm0.r1, xmm0.r2, xmm0.r3);
}
...
_mm_eq<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
                             simd_trait<double, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 4>::register_type(
        _mm_cmpeq_pd(xmm0.r0, xmm1.r0), _mm_cmpeq_pd(xmm0.r1, xmm1.r1), _mm_cmpeq_pd(xmm0.r2, xmm1.r2),
...
_mm_and<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0,
                              simd_trait<double, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_and_pd(xmm0.r0, xmm1.r0), _mm_and_pd(xmm0.r1, xmm1.r1));
}
...
_mm_and<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
                              simd_trait<double, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_and_pd(xmm0.r0, xmm1.r0), _mm_and_pd(xmm0.r1, xmm1.r1),
                                                           _mm_and_pd(xmm0.r2, xmm1.r2), _mm_and_pd(xmm0.r3, xmm1.r3));
}
...
_mm_or<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0,
                             simd_trait<double, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_or_pd(xmm0.r0, xmm1.r0), _mm_or_pd(xmm0.r1, xmm1.r1));
}
...
_mm_or<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
                             simd_trait<double, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_or_pd(xmm0.r0, xmm1.r0), _mm_or_pd(xmm0.r1, xmm1.r1),
                                                           _mm_or_pd(xmm0.r2, xmm1.r2), _mm_or_pd(xmm0.r3, xmm1.r3));
}
...
template <>
forceinline simd_trait<double, cyme::sse, 1>::register_type
_mm_xor<double, cyme::sse, 1>(simd_trait<double, cyme::sse, 1>::register_type xmm0,
                              simd_trait<double, cyme::sse, 1>::register_type xmm1) {
    return _mm_xor_pd(xmm0, xmm1);
}
...
template <>
forceinline simd_trait<double, cyme::sse, 2>::register_type
_mm_xor<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0,
                              simd_trait<double, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_xor_pd(xmm0.r0, xmm1.r0), _mm_xor_pd(xmm0.r1, xmm1.r1));
}
...
template <>
forceinline simd_trait<double, cyme::sse, 4>::register_type
_mm_xor<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
                              simd_trait<double, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_xor_pd(xmm0.r0, xmm1.r0), _mm_xor_pd(xmm0.r1, xmm1.r1),
                                                           _mm_xor_pd(xmm0.r2, xmm1.r2), _mm_xor_pd(xmm0.r3, xmm1.r3));
}
...
_mm_andnot<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0) {
    __m128d mask = _mm_castsi128_pd(_mm_set1_epi32(0xffffffff));
    return simd_trait<double, cyme::sse, 2>::register_type(_mm_andnot_pd(xmm0.r0, mask), _mm_andnot_pd(xmm0.r1, mask));
}
...
_mm_andnot<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0) {
    __m128d mask = _mm_castsi128_pd(_mm_set1_epi32(0xffffffff));
    return simd_trait<double, cyme::sse, 4>::register_type(_mm_andnot_pd(xmm0.r0, mask), _mm_andnot_pd(xmm0.r1, mask),
...
template <>
forceinline simd_trait<int, cyme::sse, 1>::register_type
_mm_cast<double, cyme::sse, 1, int>(simd_trait<double, cyme::sse, 1>::register_type xmm0) {
...
template <>
forceinline simd_trait<int, cyme::sse, 2>::register_type
_mm_cast<double, cyme::sse, 2, int>(simd_trait<double, cyme::sse, 2>::register_type xmm0) {
    return simd_trait<int, cyme::sse, 2>::register_type(_mm_castpd_si128(xmm0.r0), _mm_castpd_si128(xmm0.r1));
}
...
_mm_cast<int, cyme::sse, 1, double>(simd_trait<int, cyme::sse, 1>::register_type xmm0) {
    __m128i lo = _mm_cvtepi32_epi64(xmm0);
    return _mm_castsi128_pd(lo);
}
...
_mm_cast<int, cyme::sse, 4, double>(simd_trait<int, cyme::sse, 4>::register_type __attribute__((unused)) xmm0) {
    ...
    hi0 = _mm_cvtepi32_epi64(hi0); // C "extension" D "extension"
    hi1 = _mm_cvtepi32_epi64(hi1); // C "extension" D "extension"
...
_mm_exp<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0) {
    return simd_trait<double, cyme::sse, 2>::register_type(__svml_exp2(xmm0.r0), __svml_exp2(xmm0.r1));
}
...
_mm_exp<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0) {
    return simd_trait<double, cyme::sse, 4>::register_type(__svml_exp2(xmm0.r0), __svml_exp2(xmm0.r1),
                                                           __svml_exp2(xmm0.r2), __svml_exp2(xmm0.r3));
}
/**
...
_mm_log<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0) {
    return simd_trait<double, cyme::sse, 2>::register_type(__svml_log2(xmm0.r0), __svml_log2(xmm0.r1));
}
...
_mm_log<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0) {
    return simd_trait<double, cyme::sse, 4>::register_type(__svml_log2(xmm0.r0), __svml_log2(xmm0.r1),
                                                           __svml_log2(xmm0.r2), __svml_log2(xmm0.r3));
}
...
template <>
forceinline simd_trait<double, cyme::sse, 1>::register_type
_mm_pow<double, cyme::sse, 1>(simd_trait<double, cyme::sse, 1>::register_type xmm0,
                              simd_trait<double, cyme::sse, 1>::register_type xmm1) {
    return __svml_pow2(xmm0, xmm1);
}
...
template <>
forceinline simd_trait<double, cyme::sse, 2>::register_type
_mm_pow<double, cyme::sse, 2>(simd_trait<double, cyme::sse, 2>::register_type xmm0,
                              simd_trait<double, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 2>::register_type(__svml_pow2(xmm0.r0, xmm1.r0),
                                                           __svml_pow2(xmm0.r1, xmm0.r1));
}
...
template <>
forceinline simd_trait<double, cyme::sse, 4>::register_type
_mm_pow<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
                              simd_trait<double, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<double, cyme::sse, 4>::register_type(__svml_pow2(xmm0.r0, xmm1.r0), __svml_pow2(xmm0.r1, xmm1.r1),
                                                           __svml_pow2(xmm0.r2, xmm1.r2),
                                                           __svml_pow2(xmm0.r3, xmm1.r3));
}
...
_mm_fma<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
    ...
    return simd_trait<double, cyme::sse, 4>::register_type(
        _mm_fmadd_pd(xmm0.r0, xmm1.r0, xmm2.r0), _mm_fmadd_pd(xmm0.r1, xmm1.r1, xmm2.r1),
        _mm_fmadd_pd(xmm0.r2, xmm1.r2, xmm2.r2), _mm_fmadd_pd(xmm0.r3, xmm1.r3, xmm2.r3));
}
...
_mm_nfma<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
                               ...
                               simd_trait<double, cyme::sse, 4>::register_type xmm2) {
    return simd_trait<double, cyme::sse, 4>::register_type(
        _mm_fnmadd_pd(xmm0.r0, xmm1.r0, xmm2.r0), _mm_fnmadd_pd(xmm0.r1, xmm1.r1, xmm2.r1),
        _mm_fnmadd_pd(xmm0.r2, xmm1.r2, xmm2.r2), _mm_fnmadd_pd(xmm0.r3, xmm1.r3, xmm2.r3));
}
...
_mm_fms<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
                              ...
                              simd_trait<double, cyme::sse, 4>::register_type xmm2) {
    return simd_trait<double, cyme::sse, 4>::register_type(
        _mm_fmsub_pd(xmm0.r0, xmm1.r0, xmm2.r0), _mm_fmsub_pd(xmm0.r1, xmm1.r1, xmm2.r1),
        _mm_fmsub_pd(xmm0.r2, xmm1.r2, xmm2.r2), _mm_fmsub_pd(xmm0.r3, xmm1.r3, xmm2.r3));
}
...
_mm_nfms<double, cyme::sse, 4>(simd_trait<double, cyme::sse, 4>::register_type xmm0,
                               ...
                               simd_trait<double, cyme::sse, 4>::register_type xmm2) {
    return simd_trait<double, cyme::sse, 4>::register_type(
        _mm_fnmsub_pd(xmm0.r0, xmm1.r0, xmm2.r0), _mm_fnmsub_pd(xmm0.r1, xmm1.r1, xmm2.r1),
        _mm_fnmsub_pd(xmm0.r2, xmm1.r2, xmm2.r2), _mm_fnmsub_pd(xmm0.r3, xmm1.r3, xmm2.r3));
}
#endif // end FMA
...
_mm_load1<float, cyme::sse, 4>(const simd_trait<float, cyme::sse, 4>::value_type &a) {
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_set1_ps(a), _mm_set1_ps(a), _mm_set1_ps(a),
                                                          _mm_set1_ps(a));
}
...
_mm_load<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::const_pointer a) {
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_load_ps(a), _mm_load_ps(a + 4), _mm_load_ps(a + 8),
                                                          _mm_load_ps(a + 12));
}
...
_mm_mul<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0,
    ...
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_mul_ps(xmm0.r0, xmm1.r0), _mm_mul_ps(xmm0.r1, xmm1.r1));
}
...
_mm_mul<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0,
    ...
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_mul_ps(xmm0.r0, xmm1.r0), _mm_mul_ps(xmm0.r1, xmm1.r1),
                                                          _mm_mul_ps(xmm0.r2, xmm1.r2), _mm_mul_ps(xmm0.r3, xmm1.r3));
}
...
_mm_div<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0,
                             simd_trait<float, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_div_ps(xmm0.r0, xmm1.r0), _mm_div_ps(xmm0.r1, xmm1.r1));
}
...
_mm_div<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0,
                             simd_trait<float, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_div_ps(xmm0.r0, xmm1.r0), _mm_div_ps(xmm0.r1, xmm1.r1),
                                                          _mm_div_ps(xmm0.r2, xmm1.r2), _mm_div_ps(xmm0.r3, xmm1.r3));
}
...
_mm_add<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0,
                             simd_trait<float, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_add_ps(xmm0.r0, xmm1.r0), _mm_add_ps(xmm0.r1, xmm1.r1));
}
...
_mm_add<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0,
                             simd_trait<float, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_add_ps(xmm0.r0, xmm1.r0), _mm_add_ps(xmm0.r1, xmm1.r1),
                                                          _mm_add_ps(xmm0.r2, xmm1.r2), _mm_add_ps(xmm0.r3, xmm1.r3));
}
...
_mm_sub<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0,
                             simd_trait<float, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_sub_ps(xmm0.r0, xmm1.r0), _mm_sub_ps(xmm0.r1, xmm1.r1));
}
...
_mm_sub<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0,
                             simd_trait<float, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_sub_ps(xmm0.r0, xmm1.r0), _mm_sub_ps(xmm0.r1, xmm1.r1),
                                                          _mm_sub_ps(xmm0.r2, xmm1.r2), _mm_sub_ps(xmm0.r3, xmm1.r3));
}
...
_mm_rec<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0) {
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_rcp_ps(xmm0.r0), _mm_rcp_ps(xmm0.r1));
}
...
_mm_rec<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0) {
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_rcp_ps(xmm0.r0), _mm_rcp_ps(xmm0.r1), _mm_rcp_ps(xmm0.r2),
                                                          _mm_rcp_ps(xmm0.r3));
}
...
_mm_neg<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0) {
    simd_trait<float, cyme::sse, 1>::register_type mask(_mm_castsi128_ps(_mm_set1_epi32(0x80000000)));
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_xor_ps(xmm0.r0, mask), _mm_xor_ps(xmm0.r1, mask));
}
...
_mm_floor<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0) {
    return simd_trait<int, cyme::sse, 4>::register_type(
        _mm_cvttps_epi32(_mm_floor_ps(xmm0.r0)), _mm_cvttps_epi32(_mm_floor_ps(xmm0.r1)),
        _mm_cvttps_epi32(_mm_floor_ps(xmm0.r2)), _mm_cvttps_epi32(_mm_floor_ps(xmm0.r3)));
}
...
_mm_twok<float, cyme::sse, 2>(simd_trait<int, cyme::sse, 2>::register_type xmm0) {
    ...
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_castsi128_ps(xmm0.r0), _mm_castsi128_ps(xmm0.r1));
}
...
_mm_twok<float, cyme::sse, 4>(simd_trait<int, cyme::sse, 4>::register_type xmm0) {
    ...
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_castsi128_ps(xmm0.r0), _mm_castsi128_ps(xmm0.r1),
...
_mm_ge<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0) {
    ...
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_cvtepi32_ps(tmp0), _mm_cvtepi32_ps(tmp1));
}
...
_mm_ge<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0) {
    ...
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_cvtepi32_ps(tmp0), _mm_cvtepi32_ps(tmp1),
                                                          _mm_cvtepi32_ps(tmp2), _mm_cvtepi32_ps(tmp3));
}
...
_mm_gf<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0) {
    ...
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_castsi128_ps(tmp0), _mm_castsi128_ps(tmp1));
}
...
_mm_gf<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0) {
    ...
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_castsi128_ps(tmp0), _mm_castsi128_ps(tmp1),
...
_mm_rsqrt<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0) {
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_rsqrt_ps(xmm0.r0), _mm_rsqrt_ps(xmm0.r1));
}
...
_mm_rsqrt<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0) {
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_rsqrt_ps(xmm0.r0), _mm_rsqrt_ps(xmm0.r1),
                                                          _mm_rsqrt_ps(xmm0.r2), _mm_rsqrt_ps(xmm0.r3));
}
...
_mm_sqrt<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0) {
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_sqrt_ps(xmm0.r0), _mm_sqrt_ps(xmm0.r1));
}
...
_mm_sqrt<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0) {
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_sqrt_ps(xmm0.r0), _mm_sqrt_ps(xmm0.r1),
                                                          _mm_sqrt_ps(xmm0.r2), _mm_sqrt_ps(xmm0.r3));
}
...
_mm_fabs<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0) {
    simd_trait<float, cyme::sse, 1>::register_type mask(_mm_castsi128_ps(_mm_set1_epi32(0x7fffffff)));
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_and_ps(xmm0.r0, mask), _mm_and_ps(xmm0.r1, mask));
}
...
_mm_fabs<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0) {
    simd_trait<float, cyme::sse, 1>::register_type mask(_mm_castsi128_ps(_mm_set1_epi32(0x7fffffff)));
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_and_ps(xmm0.r0, mask), _mm_and_ps(xmm0.r1, mask),
                                                          _mm_and_ps(xmm0.r2, mask), _mm_and_ps(xmm0.r3, mask));
}
...
_mm_select_sign_sin<float, cyme::sse, 4>(simd_trait<int, cyme::sse, 4>::register_type swap,
    ...
    return simd_trait<float, cyme::sse, 4>::register_type(xmm1.r0, xmm1.r1, xmm1.r2, xmm1.r3);
}
...
_mm_select_sign_cos<float, cyme::sse, 4>(simd_trait<int, cyme::sse, 4>::register_type swap,
    ...
    return simd_trait<float, cyme::sse, 4>::register_type(xmm0.r0, xmm0.r1, xmm0.r2, xmm0.r3);
}
...
_mm_lt<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0,
                            simd_trait<float, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 4>::register_type(
        _mm_cmplt_ps(xmm0.r0, xmm1.r0), _mm_cmplt_ps(xmm0.r1, xmm1.r1), _mm_cmplt_ps(xmm0.r2, xmm1.r2),
...
_mm_eq<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0,
                            simd_trait<float, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 4>::register_type(
        _mm_cmpeq_ps(xmm0.r0, xmm1.r0), _mm_cmpeq_ps(xmm0.r1, xmm1.r1), _mm_cmpeq_ps(xmm0.r2, xmm1.r2),
...
_mm_and<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0,
                             simd_trait<float, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_and_ps(xmm0.r0, xmm1.r0), _mm_and_ps(xmm0.r1, xmm1.r1));
}
...
_mm_and<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0,
                             simd_trait<float, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_and_ps(xmm0.r0, xmm1.r0), _mm_and_ps(xmm0.r1, xmm1.r1),
                                                          _mm_and_ps(xmm0.r2, xmm1.r2), _mm_and_ps(xmm0.r3, xmm1.r3));
}
...
_mm_or<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0,
                            simd_trait<float, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_or_ps(xmm0.r0, xmm1.r0), _mm_or_ps(xmm0.r1, xmm1.r1));
}
...
_mm_or<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0,
                            simd_trait<float, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_or_ps(xmm0.r0, xmm1.r0), _mm_or_ps(xmm0.r1, xmm1.r1),
                                                          _mm_or_ps(xmm0.r2, xmm1.r2), _mm_or_ps(xmm0.r3, xmm1.r3));
}
...
template <>
forceinline simd_trait<float, cyme::sse, 1>::register_type
_mm_xor<float, cyme::sse, 1>(simd_trait<float, cyme::sse, 1>::register_type xmm0,
                             simd_trait<float, cyme::sse, 1>::register_type xmm1) {
...
template <>
forceinline simd_trait<float, cyme::sse, 2>::register_type
_mm_xor<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0,
                             simd_trait<float, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_xor_ps(xmm0.r0, xmm1.r0), _mm_xor_ps(xmm0.r1, xmm1.r1));
}
...
template <>
forceinline simd_trait<float, cyme::sse, 4>::register_type
_mm_xor<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0,
                             simd_trait<float, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_xor_ps(xmm0.r0, xmm1.r0), _mm_xor_ps(xmm0.r1, xmm1.r1),
                                                          _mm_xor_ps(xmm0.r2, xmm1.r2), _mm_xor_ps(xmm0.r3, xmm1.r3));
}
...
_mm_andnot<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0) {
    __m128 mask = _mm_castsi128_ps(_mm_set1_epi32(0xffffffff));
    return simd_trait<float, cyme::sse, 2>::register_type(_mm_andnot_ps(xmm0.r0, mask), _mm_andnot_ps(xmm0.r1, mask));
}
...
_mm_andnot<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0) {
    __m128 mask = _mm_castsi128_ps(_mm_set1_epi32(0xffffffff));
    return simd_trait<float, cyme::sse, 4>::register_type(_mm_andnot_ps(xmm0.r0, mask), _mm_andnot_ps(xmm0.r1, mask),
                                                          _mm_andnot_ps(xmm0.r2, mask), _mm_andnot_ps(xmm0.r3, mask));
}
...
_mm_exp<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0) {
    return simd_trait<float, cyme::sse, 2>::register_type(__svml_expf4(xmm0.r0), __svml_expf4(xmm0.r1));
}
...
_mm_exp<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0) {
    return simd_trait<float, cyme::sse, 4>::register_type(__svml_expf4(xmm0.r0), __svml_expf4(xmm0.r1),
                                                          __svml_expf4(xmm0.r2), __svml_expf4(xmm0.r3));
}
...
_mm_log<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0) {
    return simd_trait<float, cyme::sse, 2>::register_type(__svml_logf4(xmm0.r0), __svml_logf4(xmm0.r1));
}
...
_mm_log<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0) {
    return simd_trait<float, cyme::sse, 4>::register_type(__svml_logf4(xmm0.r0), __svml_logf4(xmm0.r1),
                                                          __svml_logf4(xmm0.r2), __svml_logf4(xmm0.r3));
}
...
template <>
forceinline simd_trait<float, cyme::sse, 1>::register_type
_mm_pow<float, cyme::sse, 1>(simd_trait<float, cyme::sse, 1>::register_type xmm0,
                             simd_trait<float, cyme::sse, 1>::register_type xmm1) {
    return __svml_powf4(xmm0, xmm1);
}
...
template <>
forceinline simd_trait<float, cyme::sse, 2>::register_type
_mm_pow<float, cyme::sse, 2>(simd_trait<float, cyme::sse, 2>::register_type xmm0,
                             simd_trait<float, cyme::sse, 2>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 2>::register_type(__svml_powf4(xmm0.r0, xmm1.r0),
                                                          __svml_powf4(xmm0.r1, xmm0.r1));
}
...
template <>
forceinline simd_trait<float, cyme::sse, 4>::register_type
_mm_pow<float, cyme::sse, 4>(simd_trait<float, cyme::sse, 4>::register_type xmm0,
                             simd_trait<float, cyme::sse, 4>::register_type xmm1) {
    return simd_trait<float, cyme::sse, 4>::register_type(
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 1>::register_type _mm_fma<float, cyme::sse, 1>(
        simd_trait<float, cyme::sse, 1>::register_type xmm0, simd_trait<float, cyme::sse, 1>::register_type xmm1,
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 2>::register_type _mm_fma<float, cyme::sse, 2>(
        simd_trait<float, cyme::sse, 2>::register_type xmm0, simd_trait<float, cyme::sse, 2>::register_type xmm1,
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 4>::register_type _mm_fma<float, cyme::sse, 4>(
        simd_trait<float, cyme::sse, 4>::register_type xmm0, simd_trait<float, cyme::sse, 4>::register_type xmm1,
        simd_trait<float, cyme::sse, 4>::register_type xmm2) {
        return simd_trait<float, cyme::sse, 4>::register_type(
            _mm_fmadd_ps(xmm0.r0, xmm1.r0, xmm2.r0), _mm_fmadd_ps(xmm0.r1, xmm1.r1, xmm2.r1),
            _mm_fmadd_ps(xmm0.r2, xmm1.r2, xmm2.r2), _mm_fmadd_ps(xmm0.r3, xmm1.r3, xmm2.r3));
    }
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 1>::register_type _mm_nfma<float, cyme::sse, 1>(
        simd_trait<float, cyme::sse, 1>::register_type xmm0, simd_trait<float, cyme::sse, 1>::register_type xmm1,
        simd_trait<float, cyme::sse, 1>::register_type xmm2) {
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 2>::register_type _mm_nfma<float, cyme::sse, 2>(
        simd_trait<float, cyme::sse, 2>::register_type xmm0, simd_trait<float, cyme::sse, 2>::register_type xmm1,
        simd_trait<float, cyme::sse, 2>::register_type xmm2) {
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 4>::register_type _mm_nfma<float, cyme::sse, 4>(
        simd_trait<float, cyme::sse, 4>::register_type xmm0, simd_trait<float, cyme::sse, 4>::register_type xmm1,
        simd_trait<float, cyme::sse, 4>::register_type xmm2) {
        return simd_trait<float, cyme::sse, 4>::register_type(
            _mm_fnmadd_ps(xmm0.r0, xmm1.r0, xmm2.r0), _mm_fnmadd_ps(xmm0.r1, xmm1.r1, xmm2.r1),
            _mm_fnmadd_ps(xmm0.r2, xmm1.r2, xmm2.r2), _mm_fnmadd_ps(xmm0.r3, xmm1.r3, xmm2.r3));
    }
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 1>::register_type _mm_fms<float, cyme::sse, 1>(
        simd_trait<float, cyme::sse, 1>::register_type xmm0, simd_trait<float, cyme::sse, 1>::register_type xmm1,
        simd_trait<float, cyme::sse, 1>::register_type xmm2) {
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 2>::register_type _mm_fms<float, cyme::sse, 2>(
        simd_trait<float, cyme::sse, 2>::register_type xmm0, simd_trait<float, cyme::sse, 2>::register_type xmm1,
        simd_trait<float, cyme::sse, 2>::register_type xmm2) {
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 4>::register_type _mm_fms<float, cyme::sse, 4>(
        simd_trait<float, cyme::sse, 4>::register_type xmm0, simd_trait<float, cyme::sse, 4>::register_type xmm1,
        simd_trait<float, cyme::sse, 4>::register_type xmm2) {
        return simd_trait<float, cyme::sse, 4>::register_type(
            _mm_fmsub_ps(xmm0.r0, xmm1.r0, xmm2.r0), _mm_fmsub_ps(xmm0.r1, xmm1.r1, xmm2.r1),
            _mm_fmsub_ps(xmm0.r2, xmm1.r2, xmm2.r2), _mm_fmsub_ps(xmm0.r3, xmm1.r3, xmm2.r3));
    }
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 1>::register_type _mm_nfms<float, cyme::sse, 1>(
        simd_trait<float, cyme::sse, 1>::register_type xmm0, simd_trait<float, cyme::sse, 1>::register_type xmm1,
        simd_trait<float, cyme::sse, 1>::register_type xmm2) {
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 2>::register_type _mm_nfms<float, cyme::sse, 2>(
        simd_trait<float, cyme::sse, 2>::register_type xmm0, simd_trait<float, cyme::sse, 2>::register_type xmm1,
        simd_trait<float, cyme::sse, 2>::register_type xmm2) {
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 4>::register_type _mm_nfms<float, cyme::sse, 4>(
        simd_trait<float, cyme::sse, 4>::register_type xmm0, simd_trait<float, cyme::sse, 4>::register_type xmm1,
        simd_trait<float, cyme::sse, 4>::register_type xmm2) {
        return simd_trait<float, cyme::sse, 4>::register_type(
            _mm_fnmsub_ps(xmm0.r0, xmm1.r0, xmm2.r0), _mm_fnmsub_ps(xmm0.r1, xmm1.r1, xmm2.r1),
            _mm_fnmsub_ps(xmm0.r2, xmm1.r2, xmm2.r2), _mm_fnmsub_ps(xmm0.r3, xmm1.r3, xmm2.r3));
    }
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 1>::register_type _mm_load1<int, cyme::sse, 1>(
        const simd_trait<int, cyme::sse, 1>::value_type &a) {
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 2>::register_type _mm_load1<int, cyme::sse, 2>(
        const simd_trait<int, cyme::sse, 2>::value_type &a) {
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 4>::register_type _mm_load1<int, cyme::sse, 4>(
        const simd_trait<int, cyme::sse, 4>::value_type &a) {
        return simd_trait<int, cyme::sse, 4>::register_type(_mm_set1_epi32(a), _mm_set1_epi32(a), _mm_set1_epi32(a),
                                                            _mm_set1_epi32(a));
    }
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 1>::register_type _mm_load<int, cyme::sse, 1>(
        simd_trait<int, cyme::sse, 1>::const_pointer a) {
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 2>::register_type _mm_load<int, cyme::sse, 2>(
        simd_trait<int, cyme::sse, 2>::const_pointer a) {
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 4>::register_type _mm_load<int, cyme::sse, 4>(
        simd_trait<int, cyme::sse, 4>::const_pointer a) {
        return simd_trait<int, cyme::sse, 4>::register_type(
    ...
    */
    template <>
    forceinline simd_trait<int, cyme::sse, 1>::register_type _mm_lt<int, cyme::sse, 1>(
        simd_trait<int, cyme::sse, 1>::register_type xmm0, simd_trait<int, cyme::sse, 1>::register_type xmm1) {
    ...
    */
    template <>
    forceinline simd_trait<int, cyme::sse, 2>::register_type _mm_lt<int, cyme::sse, 2>(
        simd_trait<int, cyme::sse, 2>::register_type xmm0, simd_trait<int, cyme::sse, 2>::register_type xmm1) {
    ...
    */
    template <>
    forceinline simd_trait<int, cyme::sse, 4>::register_type _mm_lt<int, cyme::sse, 4>(
        simd_trait<int, cyme::sse, 4>::register_type xmm0, simd_trait<int, cyme::sse, 4>::register_type xmm1) {
        return simd_trait<int, cyme::sse, 4>::register_type(
            _mm_cmplt_epi32(xmm0.r0, xmm1.r0), _mm_cmplt_epi32(xmm0.r1, xmm1.r1), _mm_cmplt_epi32(xmm0.r2, xmm1.r2),
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 1>::register_type _mm_and<int, cyme::sse, 1>(
        simd_trait<int, cyme::sse, 1>::register_type xmm0, simd_trait<int, cyme::sse, 1>::register_type xmm1) {
    ...
    */
    template <>
    forceinline simd_trait<int, cyme::sse, 2>::register_type _mm_and<int, cyme::sse, 2>(
        simd_trait<int, cyme::sse, 2>::register_type xmm0, simd_trait<int, cyme::sse, 2>::register_type xmm1) {
    ...
    */
    template <>
    forceinline simd_trait<int, cyme::sse, 4>::register_type _mm_and<int, cyme::sse, 4>(
        simd_trait<int, cyme::sse, 4>::register_type xmm0, simd_trait<int, cyme::sse, 4>::register_type xmm1) {
        return simd_trait<int, cyme::sse, 4>::register_type(
            _mm_and_si128(xmm0.r0, xmm1.r0), _mm_and_si128(xmm0.r1, xmm1.r1), _mm_and_si128(xmm0.r2, xmm1.r2),
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 1>::register_type _mm_srl<int, cyme::sse, 1>(
        simd_trait<int, cyme::sse, 1>::register_type xmm0, simd_trait<int, cyme::sse, 1>::register_type xmm1) {
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 2>::register_type _mm_srl<int, cyme::sse, 2>(
        simd_trait<int, cyme::sse, 2>::register_type xmm0, simd_trait<int, cyme::sse, 2>::register_type xmm1) {
        __m128i mask = _mm_set_epi32(0, 0, 0, 0xffffffff); // the shift is done only with the first 32 bits
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 4>::register_type _mm_srl<int, cyme::sse, 4>(
        simd_trait<int, cyme::sse, 4>::register_type xmm0, simd_trait<int, cyme::sse, 4>::register_type xmm1) {
        __m128i mask = _mm_set_epi32(0, 0, 0, 0xffffffff); // the shift is done only with the first 32 bits
        return simd_trait<int, cyme::sse, 4>::register_type(
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 1>::register_type _mm_add<int, cyme::sse, 1>(
        simd_trait<int, cyme::sse, 1>::register_type xmm0, simd_trait<int, cyme::sse, 1>::register_type xmm1) {
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 2>::register_type _mm_add<int, cyme::sse, 2>(
        simd_trait<int, cyme::sse, 2>::register_type xmm0, simd_trait<int, cyme::sse, 2>::register_type xmm1) {
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 4>::register_type _mm_add<int, cyme::sse, 4>(
        simd_trait<int, cyme::sse, 4>::register_type xmm0, simd_trait<int, cyme::sse, 4>::register_type xmm1) {
        return simd_trait<int, cyme::sse, 4>::register_type(
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 1>::register_type _mm_min<float, cyme::sse, 1>(
        simd_trait<float, cyme::sse, 1>::register_type xmm0, simd_trait<float, cyme::sse, 1>::register_type xmm1) {
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 2>::register_type _mm_min<float, cyme::sse, 2>(
        simd_trait<float, cyme::sse, 2>::register_type xmm0, simd_trait<float, cyme::sse, 2>::register_type xmm1) {
        return simd_trait<float, cyme::sse, 2>::register_type(_mm_min_ps(xmm0.r0, xmm1.r0),
                                                              _mm_min_ps(xmm0.r1, xmm1.r1));
    }
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 4>::register_type _mm_min<float, cyme::sse, 4>(
        simd_trait<float, cyme::sse, 4>::register_type xmm0, simd_trait<float, cyme::sse, 4>::register_type xmm1) {
        return simd_trait<float, cyme::sse, 4>::register_type(
            _mm_min_ps(xmm0.r0, xmm1.r0), _mm_min_ps(xmm0.r1, xmm1.r1), _mm_min_ps(xmm0.r2, xmm1.r2),
            _mm_min_ps(xmm0.r3, xmm1.r3));
    }
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 1>::register_type _mm_cast<float, cyme::sse, 1, int>(
        simd_trait<float, cyme::sse, 1>::register_type xmm0) {
        return _mm_castps_si128(xmm0);
    }
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 2>::register_type _mm_cast<float, cyme::sse, 2, int>(
        simd_trait<float, cyme::sse, 2>::register_type xmm0) {
        return simd_trait<int, cyme::sse, 2>::register_type(_mm_castps_si128(xmm0.r0), _mm_castps_si128(xmm0.r1));
    }
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 4>::register_type _mm_cast<float, cyme::sse, 4, int>(
        simd_trait<float, cyme::sse, 4>::register_type xmm0) {
        return simd_trait<int, cyme::sse, 4>::register_type(_mm_castps_si128(xmm0.r0), _mm_castps_si128(xmm0.r1),
                                                            _mm_castps_si128(xmm0.r2), _mm_castps_si128(xmm0.r3));
    }
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 1>::register_type _mm_cast<int, cyme::sse, 1, float>(
        simd_trait<int, cyme::sse, 1>::register_type xmm0) {
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 2>::register_type _mm_cast<int, cyme::sse, 2, float>(
        simd_trait<int, cyme::sse, 2>::register_type xmm0) {
        return simd_trait<float, cyme::sse, 2>::register_type(_mm_castsi128_ps(xmm0.r0), _mm_castsi128_ps(xmm0.r1));
    }
     ...
     */
    template <>
    forceinline simd_trait<float, cyme::sse, 4>::register_type _mm_cast<int, cyme::sse, 4, float>(
        simd_trait<int, cyme::sse, 4>::register_type xmm0) {
        return simd_trait<float, cyme::sse, 4>::register_type(_mm_castsi128_ps(xmm0.r0), _mm_castsi128_ps(xmm0.r1),
                                                              _mm_castsi128_ps(xmm0.r2), _mm_castsi128_ps(xmm0.r3));
    }
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 1>::register_type _mm_gt<int, cyme::sse, 1>(
        simd_trait<int, cyme::sse, 1>::register_type xmm0, simd_trait<int, cyme::sse, 1>::register_type xmm1) {
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 2>::register_type _mm_gt<int, cyme::sse, 2>(
        simd_trait<int, cyme::sse, 2>::register_type xmm0, simd_trait<int, cyme::sse, 2>::register_type xmm1) {
     ...
     */
    template <>
    forceinline simd_trait<int, cyme::sse, 4>::register_type _mm_gt<int, cyme::sse, 4>(
        simd_trait<int, cyme::sse, 4>::register_type xmm0, simd_trait<int, cyme::sse, 4>::register_type xmm1) {
        return simd_trait<int, cyme::sse, 4>::register_type(

...
forceinline bool _mm_is_empty<double, cyme::sse, 1>(simd_trait<double, cyme::sse, 1>::register_type xmm0) {
    simd_trait<double, cyme::sse, 1>::register_type mask(_mm_castsi128_pd(_mm_set1_epi64x(0xffffffffffffffff)));
...
forceinline bool _mm_is_empty<float, cyme::sse, 1>(simd_trait<float, cyme::sse, 1>::register_type xmm0) {
    simd_trait<float, cyme::sse, 1>::register_type mask(_mm_castsi128_ps(_mm_set1_epi64x(0xffffffff)));

...
namespace cyme{
    ...
    */
    template<>
    forceinline simd_trait<float,cyme::neon,2>::register_type
    _mm_load<float,cyme::neon,2>(simd_trait<float,cyme::neon,2>::const_pointer __attribute__((unused))a){
	assert(false);
    }
    ...
    */
    template<>
    forceinline simd_trait<float,cyme::neon,4>::register_type
    _mm_load<float,cyme::neon,4>(simd_trait<float,cyme::neon,4>::const_pointer __attribute__((unused))a){
	assert(false);
    }
    ...
    */
    template<>
    forceinline void
    _mm_store<float,cyme::neon,2>(simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm0,
                                  simd_trait<float,cyme::neon,2>::pointer __attribute__((unused))a){
	assert(false);
    }
    ...
    */
    template<>
    forceinline void
    _mm_store<float,cyme::neon,4>(simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm0,
                                  simd_trait<float,cyme::neon,4>::pointer __attribute__((unused))a){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,1>::register_type
    _mm_rec<float,cyme::neon,1>(simd_trait<float,cyme::neon,1>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,2>::register_type
    _mm_rec<float,cyme::neon,2>(simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,4>::register_type
    _mm_rec<float,cyme::neon,4>(simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,1>::register_type
    _mm_neg<float,cyme::neon,1>(simd_trait<float,cyme::neon,1>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,2>::register_type
    _mm_neg<float,cyme::neon,2>(simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,4>::register_type
    _mm_neg<float,cyme::neon,4>(simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    _mm_floor<float,cyme::neon,1>(simd_trait<float,cyme::neon,1>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    _mm_floor<float,cyme::neon,2>(simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    _mm_floor<float,cyme::neon,4>(simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,2>::register_type
    _mm_fma<float,cyme::neon,2>(simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm0,
                               simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm1,
                               simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,4>::register_type
    _mm_fma<float,cyme::neon,4>(simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm0,
                               simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm1,
                               simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,1>::register_type
    _mm_nfma<float,cyme::neon,1>(simd_trait<float,cyme::neon,1>::register_type __attribute__((unused))xmm0,
                                simd_trait<float,cyme::neon,1>::register_type __attribute__((unused))xmm1,
                                simd_trait<float,cyme::neon,1>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,2>::register_type
    _mm_nfma<float,cyme::neon,2>(simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm0,
                                simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm1,
                                simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,4>::register_type
    _mm_nfma<float,cyme::neon,4>(simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm0,
                                simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm1,
                                simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,2>::register_type
    _mm_fms<float,cyme::neon,2>(simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm0,
                               simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm1,
                               simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<float,cyme::neon,4>::register_type
    _mm_fms<float,cyme::neon,4>(simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm0,
                               simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm1,
                               simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    */
    template<>
    forceinline simd_trait<float,cyme::neon,1>::register_type
    _mm_nfms<float,cyme::neon,1>(simd_trait<float,cyme::neon,1>::register_type __attribute__((unused))xmm0,
                                simd_trait<float,cyme::neon,1>::register_type __attribute__((unused))xmm1,
                                simd_trait<float,cyme::neon,1>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    */
    template<>
    forceinline simd_trait<float,cyme::neon,2>::register_type
    _mm_nfms<float,cyme::neon,2>(simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm0,
                                simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm1,
                                simd_trait<float,cyme::neon,2>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    */
    template<>
    forceinline simd_trait<float,cyme::neon,4>::register_type
    _mm_nfms<float,cyme::neon,4>(simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm0,
                                simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm1,
                                simd_trait<float,cyme::neon,4>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
...
/*--------------------------------------------------------------------- double ---------------*/
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,2>::register_type
    _mm_load<double,cyme::neon,2>(simd_trait<double,cyme::neon,2>::const_pointer __attribute__((unused))a){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,4>::register_type
    _mm_load<double,cyme::neon,4>(simd_trait<double,cyme::neon,4>::const_pointer __attribute__((unused))a){
	assert(false);
    }
    ...
    template<>
    forceinline void
    _mm_store<double,cyme::neon,2>(simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm0,
                                   simd_trait<double,cyme::neon,2>::pointer __attribute__((unused))a){
	assert(false);
    }
    ...
    template<>
    forceinline void
    _mm_store<double,cyme::neon,4>(simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm0,
                                   simd_trait<double,cyme::neon,4>::pointer __attribute__((unused))a){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,1>::register_type
    _mm_rec<double,cyme::neon,1>(simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,2>::register_type
    _mm_rec<double,cyme::neon,2>(simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,4>::register_type
    _mm_rec<double,cyme::neon,4>(simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,1>::register_type
    _mm_neg<double,cyme::neon,1>(simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm0){
	assert(false);
}
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,2>::register_type
    _mm_neg<double,cyme::neon,2>(simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,4>::register_type
    _mm_neg<double,cyme::neon,4>(simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<int,cyme::neon,2>::register_type
    _mm_floor<double,cyme::neon,2>(simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<int,cyme::neon,4>::register_type
    _mm_floor<double,cyme::neon,4>(simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,1>::register_type
    _mm_twok<double,cyme::neon,1>(simd_trait<int,cyme::neon,1>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,2>::register_type
    _mm_twok<double,cyme::neon,2>(simd_trait<int,cyme::neon,2>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,4>::register_type
    _mm_twok<double,cyme::neon,4>(simd_trait<int,cyme::neon,4>::register_type __attribute__((unused))xmm0){
	assert(false);
    }
   ...
   /**
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,1>::register_type
    _mm_fma<double,cyme::neon,1>(simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm0,
                                simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm1,
                                simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,2>::register_type
    _mm_fma<double,cyme::neon,2>(simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm0,
                                simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm1,
                                simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,4>::register_type
    _mm_fma<double,cyme::neon,4>(simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm0,
                                simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm1,
                                simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,1>::register_type
    _mm_nfma<double,cyme::neon,1>(simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm0,
                                 simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm1,
                                 simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,2>::register_type
    _mm_nfma<double,cyme::neon,2>(simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm0,
                                 simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm1,
                                 simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,4>::register_type
    _mm_nfma<double,cyme::neon,4>(simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm0,
                                 simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm1,
                                 simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,1>::register_type
    _mm_fms<double,cyme::neon,1>(simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm0,
                                simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm1,
                                simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,2>::register_type
    _mm_fms<double,cyme::neon,2>(simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm0,
                                simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm1,
                                simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    template<>
    forceinline simd_trait<double,cyme::neon,4>::register_type
    _mm_fms<double,cyme::neon,4>(simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm0,
                                simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm1,
                                simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    */
    template<>
    forceinline simd_trait<double,cyme::neon,1>::register_type
    _mm_nfms<double,cyme::neon,1>(simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm0,
                                 simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm1,
                                 simd_trait<double,cyme::neon,1>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    */
    template<>
    forceinline simd_trait<double,cyme::neon,2>::register_type
    _mm_nfms<double,cyme::neon,2>(simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm0,
                                 simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm1,
                                 simd_trait<double,cyme::neon,2>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
    ...
    */
    template<>
    forceinline simd_trait<double,cyme::neon,4>::register_type
    _mm_nfms<double,cyme::neon,4>(simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm0,
                                 simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm1,
                                 simd_trait<double,cyme::neon,4>::register_type __attribute__((unused))xmm2){
	assert(false);
    }
